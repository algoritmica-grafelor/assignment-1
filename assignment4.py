        ...
        if distances[u] != float('-inf'):  # Only process reachable vertices
            ...
            for v in graph.neighbors(u):
                ...
                try:
                    ...
                    # If get_weight throws an error (e.g., KeyError) for unweighted edges
                    weight = 1
                # -----------------------------------------------

                # Relaxation for HIGHEST cost (maximize distance)
...
def main():
    ...
    try:
        ...
        print(f"Checking graph '{graph_file}' and calculating highest cost path...")
